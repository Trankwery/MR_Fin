function[h_CCD_norm]=aberracja1(alpha_0,h_CCD_max,fi_diafragmy,lambda)
%  Funkcja pozwala wyznaczyæ zwi¹zek miêdzy alpha_0 i h_CCD_norm
% (h_CCD unormowane do h_CCD_max);
% 
% alpha_0 w radianach
% h_CCD_max w m
...
f=f_H-VH+L/2;
L_TOT=0.04257; %%-Oleg³oœæ miêdzy soczewkami w m
